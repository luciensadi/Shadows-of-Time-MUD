...
void save_mobile (FILE * fp, MOB_INDEX_DATA * pMobIndex)
{
    ...
    fprintf (fp, "%d %d\n", pMobIndex->load_time.start, pMobIndex->load_time.end);
 ...
 */
       ...
       case ITEM_KEYRING:
        ...
        case ITEM_BOMB:
		    ...
		    fwrite_flag (pObjIndex->value[0], buf),
	            explosive_name (pObjIndex->value[1]));
            strcpy(buf, "0");
            fprintf(fp, " %s %ld 0\n",
    ...
    for (pAf = pObjIndex->affected; pAf; pAf = pAf->next)
    {
	    ...
	    //Need to add more to save affects to area files && add line to read this line && have it save somehow <shrug> - Camm
            //ie.
            if (IS_SPELL_AFFECT(pAf->location))
            fprintf( fp, "'%s' %3d %3d %3d %3d %3d %10d\n",  
            skill_table[pAf->type].name,pAf->where,pAf->level,pAf->duration,pAf->location,pAf->modifier,pAf->bitvector);
            else
            fprintf( fp, "%3d %3d %10d\n", pAf->location, pAf->modifier, pAf->bitvector);
    ...
    fprintf(fp, " T %d %s~\n",
    pObjIndex->timer,pObjIndex->timer_msg);
                     ...
                     pReset = pReset->next)
                {
                    switch (pReset->command)
                    {
                        ...
                        case 'M':
                            ...
                            fprintf (fp, "M 0 %ld %ld %ld %ld %d Load %s\n",
                                     pReset->arg1,
                                     pReset->arg2,
                                     pReset->arg3,
                                     pReset->arg4,
				     ...
				     pLastMob->short_descr);
                        ...
                        case 'O':
                            ...
                            fprintf (fp, "O 0 %ld 0 %ld 0 %d %s loaded to %s\n",
                                     pReset->arg1,
                                     pReset->arg3,
                                     pReset->percent, 
                        ...
                        case 'P':
                            pLastObj = get_obj_index (pReset->arg1);
                            fprintf (fp, "P 0 %ld %ld %ld %ld %d %s put inside %s\n",
                                     pReset->arg1,
                                     pReset->arg2,
                                     pReset->arg3,
                                     pReset->arg4,
                        ...
                        case 'G':
                            fprintf (fp, "G 0 %ld 0 0 0 %d %s is given to %s\n",
                                     pReset->arg1,
                                     pReset->percent, 
                                     capitalize (get_obj_index
                                                 (pReset->arg1)->short_descr),
                        ...
                        case 'E':
                            fprintf (fp,
                                     "E 0 %ld 0 %ld 0 %d %s is loaded %s of %s\n",
...
//        save_area_list ();	only on asave world! this is used in copyovers
