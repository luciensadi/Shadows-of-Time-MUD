...
DECLARE_SPELL_FUN(	spell_airbarrier	);
DECLARE_SPELL_FUN(      spell_asmodeus_bless    );
...
DECLARE_SPELL_FUN(      spell_curse_obj         );  
...
DECLARE_SPELL_FUN(	spell_frighten		);
...
DECLARE_SPELL_FUN(      spell_iron_grip         );
...
DECLARE_SPELL_FUN(      spell_poison_missile    );
...
DECLARE_SPELL_FUN(	spell_unravel     	);
...
DECLARE_SPELL_FUN(	spell_berry		);
DECLARE_SPELL_FUN(	spell_dimensional_alienation	);
...
DECLARE_SPELL_FUN(      spell_save_life          );
DECLARE_SPELL_FUN(	spell_rift		);
DECLARE_SPELL_FUN( 	spell_disorient		);
DECLARE_SPELL_FUN(	spell_fire_blossom	);
