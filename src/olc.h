...
int    str_flag_value           args (( const struct flag_type *flag_table, char *argument));                                
...
DECLARE_OLC_FUN( oedit_class             );  /* ROM */
...
DECLARE_OLC_FUN( medit_load_time	);  /* ROM */
...
DECLARE_OLC_FUN( gedit_display		);
DECLARE_OLC_FUN( gedit_who		);
DECLARE_OLC_FUN( gedit_commands		);
...
DECLARE_OLC_FUN( qedit_showname            );
DECLARE_OLC_FUN( qedit_show            );
DECLARE_OLC_FUN( qedit_cost            );
DECLARE_OLC_FUN( qedit_level            );
DECLARE_OLC_FUN( qedit_create           );
DECLARE_OLC_FUN( qedit_list            );
DECLARE_OLC_FUN( qedit_special            );
DECLARE_OLC_FUN( qedit_delete            );
DECLARE_OLC_FUN( qedit_vnum            );
...
#define EDIT_GUILD(Ch, Guild)	( Guild = (CLAN_DATA *)Ch->desc->pEdit )
#define EDIT_QUEST(Ch, Quest)	( Quest = (QPRIZE_DATA *)Ch->desc->pEdit )
