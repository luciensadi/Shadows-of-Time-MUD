...
DECLARE_DO_FUN( do_mpaddsaid    );
DECLARE_DO_FUN( do_mpaddquest   );
DECLARE_DO_FUN( do_mpcompletequeststep   );
DECLARE_DO_FUN( do_mpupdatequeststatus   );
DECLARE_DO_FUN( do_mprandomoload );
/*
