...
bool    IS_MURDERER     args( (CHAR_DATA * ch) );
bool    IS_THIEF        args( (CHAR_DATA * ch) );
bool    IS_JAILED       args( (CHAR_DATA * ch) );
bool    IS_GUILDMASTER  args( (CHAR_DATA * ch) );
bool    IS_GUILDED      args( (CHAR_DATA * ch) );
